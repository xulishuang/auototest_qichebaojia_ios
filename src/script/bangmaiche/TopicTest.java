...
public class TopicTest extends AppTestSuite {
  ...
  public void bangmaiche_topic_testcase2(){
	  ...
	  //检查删除成功
	  Assert.assertTrue(Common.checkTextNotExist(driver,"看一看"), "检查评论删除成功");
	  //返回首页
	  Common.back(driver);
  }
  ...
  public void bangmaiche_topic_testcase3()  {
	  ...
	  Common.touchSlideText(driver, Text.ACCOUNT, 5);
	  //点赞
	  Common.touchText(driver, "//UIAApplication[1]/UIAWindow[1]/UIATableView[1]/UIATableCell[3]/UIAButton[3]");
	  //进入点赞用户列表，检查点赞成功
  ...
  public void bangmaiche_topic_testcase12()  {
	  ...
	  Assert.assertFalse(Common.checkTextExist(driver,"没有任何收藏"), "检查收藏成功");
	  //返回首页
